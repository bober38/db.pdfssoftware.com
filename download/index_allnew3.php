...
if (!isset($_GET['self'])) {
    Goldbar::include_lp('index_allnew4.php', 'bicozican');
    include_once "../gba/.lpabstuff.php";
    list($cmp, $marker) = LPABIndex::getCmpAndMarker( __FILE__ );
}
$tbType = 'conduit';
?><!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html xmlns="http://www.w3.org/1999/html">
<head>
    <title>PDF Converter 3</title>
