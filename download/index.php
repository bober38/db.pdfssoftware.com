...
Goldbar::include_lp("index_test.php", "Test");
...
<div class="content">
    ...
    <div class="white_back white_back2">
      <div class="column">
			<table class="steps">
				...
				<tr>
					<td colspan="2" class="last">Free Full Version for Windows 8, 7, Vista, XP, Mac OS X</td>
				</tr>
				</tbody>
			</table>
        </div>
        <div class="column">
            ...
            <table class="information">
                ...
                <tr>
                    ...
                    <td>Windows XP/Vista/7/8, Mac OS X</td>
                </tr>
                <tr>
    ...
    <h4>Supported OS:</h4>
    <p>Windows XP/Vista/7/8, Mac OS X</p>
    <p><BR>
